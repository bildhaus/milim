...
| Google Workspace (desktop-internal) | Authenticated connection status, system-browser Picker, selected-file registry, disconnect/revoke, MIME-aware preview, and bounded media proxy routes under `/google-workspace/*` |
