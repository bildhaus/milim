...
Scheduled occurrences enter that same canonical control path: each one has a durable origin, timeline, and run ledger, appears on desktop and mobile, and remains idempotent when dispatch is retried.
