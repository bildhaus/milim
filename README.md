...
- **Your runtime choice.** Switch the next turn between hosted providers, Ollama or LM Studio, and separately installed Codex, Claude, OpenCode, or Pi runtimes. Thread history stays put.
