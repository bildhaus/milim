...
| Canonical control v1 | `GET /control/v1/bootstrap`, `GET /control/v1/threads/{id}/timeline`, authenticated `GET /control/v1/runs/{run_id}`, paged `GET /control/v1/runs/{run_id}/events`, `POST /control/v1/commands`, `POST /control/v1/socket-ticket`, `GET /control/v1/ws?ticket=...` |
