...
equal(nativeBadgeThreadCount({ sessions: [{ id: "approval", messages: [{ ...pendingApproval, streamParts: [pendingApproval.streamParts[0], { ...pendingApproval.streamParts[0], label: "Approved", approvalStatus: "approved" }] }] }], projects: [], unreadSessionIds: [], workerRuns: [] }), 0, "resolved canonical approvals should supersede their historical pending event");
